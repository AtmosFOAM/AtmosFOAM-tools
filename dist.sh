...
dch --create --package "atmosfoam-tools" --distribution $UBUNTU_CODENAME --newversion=$VERSION "Build for $(git rev-parse HEAD)"
...
deb-s3 upload --bucket atmosfoam-apt --codename=$UBUNTU_CODENAME --component=dev ../atmosfoam-tools_${VERSION}_amd64.deb
